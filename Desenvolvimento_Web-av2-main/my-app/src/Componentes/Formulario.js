    ...
    <form className="form" onSubmit={handleSubmit}>
      <div className="form-group">
        ...
        <input
          ...
          required
        />
        <span className="error">{formErrors.nameError}</span><br /><br />
      </div>
      <div className="form-group">
        E-mail:<br />
        <input
          ...
          required
        />
        <span className="error">{formErrors.emailError}</span><br /><br />
      </div>
      <div className="form-group">
        Telefone:<br />
        <input
          ...
          required
        />
        <span className="error">{formErrors.foneError}</span><br /><br />
      </div>
